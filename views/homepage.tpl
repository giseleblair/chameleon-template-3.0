	...
	<div id="slick-hero">
		...
		<div class=""  >
			<header style="background-image:url('{{slide.background_image.getImage(2500)}}');background-position:{{slide.horizontal_alignment_for_mobile}};" >
				<video autoplay="" loop="" muted="" class="hide-for-sm" style="margin: auto; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 100%"><source src="{{ slide.background_video.getMediaURL() }}" type="video/mp4"></video>
